...
<div class="split-display left">
    <p class="meta-text-left">FRAME COUNT: ${ getJsonDetail(draggedDicomId, 'config', 'number_of_frames') }</p>
    <p class="meta-text-center">DICOM ID: ${draggedDicomId}</p>
    <p class="meta-text-right">${ getJsonDetail(draggedDicomId, 'predicted_view') }</p>
    <div class="analysis-div">
        <video type="video/mp4" loop autoplay class="analysis-img ${draggedDicomId}" src="${ getJsonDetail(draggedDicomId, 'paths', 'path_to_dicom_webm') }" data-id="${draggedDicomId}">
        </video>
    </div>
</div>
<div class="split-display right">
    ...
    <p class="meta-text-right">${ getJsonDetail(draggedDicomId, 'predicted_view') }</p>
    <div class="analysis-div">
        <video type="video/mp4" loop autoplay class="analysis-img ${draggedDicomId}" data-directory="${ getDefaultDataDirectory(getJsonDetail(draggedDicomId, 'predicted_view'))}" src="${ getJsonDetail(draggedDicomId, 'paths', getDefaultDataDirectory(getJsonDetail(draggedDicomId, 'predicted_view'))) }" data-id="${draggedDicomId}">
        </video>
    </div>
</div>
