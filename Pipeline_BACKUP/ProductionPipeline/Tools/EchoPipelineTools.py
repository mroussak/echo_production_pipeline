...
def seg_postprocessing_apical(seg_dictionary):
    ...
    for idx, pred in enumerate(seg_dictionary['mask']):
        ...
        if (mask==0.0).all():
            ...
            im.save('%s/%s.jpg' %(seg_dictionary['path_to_mask_jpeg'], str(idx).zfill(4)))
    ...
    #         Using connected components
            ...
            im.save('%s/%s.jpg' %(seg_dictionary['path_to_simpsons_jpeg'], str(idx).zfill(4)))
...
def seg_postprocessing_psax(seg_dictionary):
    ...
    #         Using connected components
            ...
            im.save('%s/%s.jpg' %(seg_dictionary['path_to_cylinder_jpeg'], str(idx).zfill(4)))
